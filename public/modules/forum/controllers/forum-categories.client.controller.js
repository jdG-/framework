	...
	function($scope, $stateParams, $location, $http, Authentication, ForumCategories) {
		...
		$scope.create = function() {
            ...
            var log = {
                ...
                action: 'create categoriy on: ' + $location.path()
            };
		...
		$scope.remove = function(forumCategory) {
            var log = {
                user: Authentication.user._id,
                action: 'delete a category on: ' + $location.path()
            };
		...
		$scope.update = function() {
            ...
            var log = {
                user: Authentication.user._id,
                action: 'update a category on: ' + $location.path()
            };
		...
		$scope.find = function() {
            var log = {
                user: Authentication.user._id,
                action: 'list of categories on: ' + $location.path()
            };
		...
		$scope.findOne = function() {
            var log = {
                user: Authentication.user._id,
                action: 'view a category on: ' + $location.path()
            };
